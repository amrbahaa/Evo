...
MONGODB_ADMIN_PASS=${MONGODB_ADMIN_PASS:-"evo_123"}

# Application Database User
MONGODB_APPLICATION_DATABASE=${MONGODB_APPLICATION_DATABASE:-"evodb"}
MONGODB_APPLICATION_USER=${MONGODB_APPLICATION_USER:-"evouser"}
MONGODB_APPLICATION_PASS=${MONGODB_APPLICATION_PASS:-"evo_456"}
...
db.createUser({user: '$MONGODB_APPLICATION_USER', pwd: '$MONGODB_APPLICATION_PASS', roles:[{role:'dbOwner', db:'$MONGODB_APPLICATION_DATABASE'}, {role:'userAdmin', db:'$MONGODB_APPLICATION_DATABASE'}]});
EOF
fi
